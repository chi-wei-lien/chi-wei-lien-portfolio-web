...
const surveyPaper: ProjectCardData = {
    ...
    descr: <p>Chi-Wei Lien and Sudip Vhaduri, {"\""}Challenges and Opportunities of Biometric User Authentication in the Age of IoT: A Survey,{"\""} <span className="underline decoration-2 decoration-pink-500">ACM Computing Surveys, 2022</span> (Under Review)</p>,
    content:
...
const heartAuth: ProjectCardData = {
    ...
    descr: <p>Collaborating with Prof. Vhaduri to develop a <span className="underline decoration-pink-500 decoration-2">heart biometric model</span> for user authentication</p>,
    content:
        <ul className="list-disc">
            <li>
...
const education: ProjectCardData = {
    ...
    descr: <p>Bachelor of Science in Computer Science, <span className="underline decoration-pink-500 decoration-2">GPA: 4.0, Dean's Honor List</span><br />2021 Aug - 2024 Dec</p>,
    content:
        <ul className="list-disc">
            <li>
